  ...
  return (
    <button
      className={cn(
        ...
        tone === "primary" &&
          "border-transparent bg-[var(--app-accent)] text-[var(--app-text-on)] shadow-[var(--sh-xs)] hover:bg-[var(--app-accent-strong)] active:bg-[var(--app-accent-strong)]",
        tone === "secondary" &&
        ...
        tone === "danger" &&
          "border-transparent bg-[var(--app-red)] text-[var(--app-text-on)] hover:bg-[var(--app-red-text)]",
        tone === "danger-ghost" &&
